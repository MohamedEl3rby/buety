        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text("Information about breast surgeries",style: TextStyle(
                color: Color(0xffC6A074),fontSize: 21,fontWeight: FontWeight.bold,
              ),),
            ),
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text("When talking about breast surgeries, we confirm that there are no useful creams, devices, hormones or exercises that can replace surgery which is the only fruitful solution.",style: TextStyle(
            ...
            const SizedBox(
             ...
             Padding(
              ...
              child: Row(
                ...
                children:const [
                  Text("Intro to Breast development",style: TextStyle(
                    color: Color(0xffC6A074),fontSize: 19,fontWeight: FontWeight.bold,
                  ),),
                ],
              ),
            ),
            ...
            Container(
              ...
              child: const Center(
                child: Padding(
                  ...
                  child: Text("BREASTS COSMETIC SURGERIES INCLUDE:",style: TextStyle(
         ...
         Row(
           ...
           children: const [
              Padding(
                padding: EdgeInsets.all(8.0),
                child: Text("Breast Augmentation:",style: TextStyle(
                 color: Color(0xffC6A074),fontSize: 16,
             ),),
              ),
           ],
          ...
          Padding(
            ...
            child: Row(
              ...
              children: const [
                 Padding(
                   padding: EdgeInsets.all(8.0),
                   child: Text("Introduction to the surgery:",style: TextStyle(

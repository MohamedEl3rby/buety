        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text("Information about body ",style: TextStyle(
                color: Color(0xffC6A074),fontSize: 21,fontWeight: FontWeight.bold,
              ),),
            ),
            const Text("cosmetic surgeries",style: TextStyle(
              color: Color(0xffC6A074),fontSize: 21,fontWeight: FontWeight.bold,
            ),),
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text("Fitness is a gift that all people seek, to feel healthy and confident, also to feel desirous within the community around us. The overweight individual loses all of these advantages and that will surely affect his/her psychological and physical status negatively.",style: TextStyle(
          ...
          Row(
            ...
            children: const [
              Padding(
                padding: EdgeInsets.all(8.0),
                child: Text("Introduction to body cosmetic surgeries: ",style: TextStyle(
                  color: Color(0xffC6A074),fontSize: 16,fontWeight: FontWeight.bold,
                ),),
              ),
            ],
          ),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: const Center(
                  child: Text("TREATMENT METHODS",style: TextStyle(
            ...
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text("Treatment methods are different according to many factors such as level of obesity, patient activities and how he responds to the treatment in addition to his will and desire to achieve the goal behind the treatment and finally reaching an acceptable level of fitness that satisfies him.",style: TextStyle(
                color: Color(0xffC6A074),fontSize: 16,
              ),),
            ),
             Row(
               ...
               children: const [
                 Padding(
                   padding: EdgeInsets.all(8.0),
                   child: Text("Body reshaping surgeries: ",style: TextStyle(
                     color: Color(0xffC6A074),fontSize: 16,fontWeight: FontWeight.bold,
                   ),),
                 ),
               ],

        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text("Information about ",style: TextStyle(
                color: Color(0xffC6A074),fontSize: 21,fontWeight: FontWeight.bold,
              ),),
            ),
            Text("Cosmetic Without Surgery",style: TextStyle(
              color: Color(0xffC6A074),fontSize: 21,fontWeight: FontWeight.bold,
            ),),
            Image.asset(
              AssetPath.image25,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: const [
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text("Treatment Purposes:",style: TextStyle(

        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text("Information about Genital",style: TextStyle(
                color: Color(0xffC6A074),fontSize: 21,fontWeight: FontWeight.bold,
              ),),
            ),
            Text("cosmetic surgery",style: TextStyle(
              color: Color(0xffC6A074),fontSize: 21,fontWeight: FontWeight.bold,
            ),),
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text("A lot of changes appear on women After pregnancy and giving birth. These changes may reduce the husband’s sexual pleasure; for example, gaining weight that may reach obesity that can be handled by going on a balanced diet and working out. But the most dangerous change is the wide and flaccid muscles of the vagina. 50% of women are suffering this specially after giving birth before by the help of midwives.",style: TextStyle(
            ...
            Padding(
              ...
              child: Row(
                ...
                children:const [
                  Text("Enjoyment obstacles",style: TextStyle(
            ...
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text("The sexual enjoyment of the husband and wife requires a healthy vagina with no flabbiness but unfortunately, women get flabby vaginas after multiple births which hinders sexual enjoyment.",style: TextStyle(
                color: Color(0xffC6A074),fontSize: 16,
              ),),
            ),
            const SizedBox(
            ...
            Container(
              ...
              child: const Center(
                child: Text("LABIOPLASTY",style: TextStyle(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: const [
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text("Who shall have this surgery?",style: TextStyle(

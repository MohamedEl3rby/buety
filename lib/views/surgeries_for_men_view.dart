...
class SurgeriesForMenView extends StatelessWidget {
  const SurgeriesForMenView({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                padding: EdgeInsets.all(paddingValue),
                child: Text(
                  "Beauty is everyone’s right including men and they have big share of cosmetic surgeries nowadays.",
                  style: TextStyle(
                    color: Color(0xffC6A074),
                    fontSize: 16,
                  ),
              ...
              const Padding(
                padding: EdgeInsets.all(paddingValue),
                child: Text(
                  "Men have breast glands which are touchable, precise and solid, located under the nipples in both breasts causing no symptoms but if its diameter exceeds 2 cm and the breast began to be noticeable, then it will be diagnosed as Gynecomastia Surgical Details: Anesthesia: The surgery is done under general or local anesthesia as what the patient desires. Surgery Duration: This surgery takes from 1 to 1:30 hour. Surgery Description: It is a simple surgery with very few problems especially after the invention of Liposuction technology that saved a lot of young men from excision surgeries problems such as scars, excavated breast problems, uneven breasts, nipples immersion and deformities. Liposuction helped a lot in curing these symptoms specially first and second degrees of Gynecomastia. Extreme cases that include an extreme flabbiness require having the excess skin removed with unnoticeable scars in most cases. All of those are one day surgeries in which the patent returns back home after few hours and goes back to his work few days after the surgery but also continues to wear the medical belt for couple of weeks and exercises his chest muscles. Gynecomastia is no longer a problem as it was before, just choosing the right surgeon. Convalescence: checking out at the same day.",
                  style: TextStyle(
                    color: Color(0xffC6A074),
                    fontSize: 16,
                  ),
              ...
              const Padding(
                padding: EdgeInsets.all(paddingValue),
                child: Text(
                  "Hair care and baldness treatment",
                  style: TextStyle(
                    color: Color(0xffC6A074),
                    fontSize: 21,
                    fontWeight: FontWeight.bold,

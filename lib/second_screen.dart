        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Center(
                child: Text("Information about face and ",style: TextStyle(
                  color: Color(0xffC6A074),fontSize: 21,fontWeight: FontWeight.bold,
                ),),
              ),
            ),
            const Center(
              child: Text(" nose cosmetic surgeries",style: TextStyle(
                color: Color(0xffC6A074),fontSize: 21,fontWeight: FontWeight.bold,
              ),),
            ),
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text("The Human is always looking for a pretty and harmonious face with firmer and fresher look. The face is a mirror that reflects the one’s personality, growth levels and age signs that appear later in life according to environmental, climatic and genetic factors, also activities and food.",style: TextStyle(
            ...
            Padding(
              ...
              child: Row(
                ...
                children:const [
                  Text("Problems that face cosmetic surgeries can fix:",style: TextStyle(
            ...
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text(" - Deep Wrinkles under the eyes, along the nose and the mouth - Jaws redundant skin - Neck fat - Face abnormalities - Double chin - Scars and burns",style: TextStyle(
                color: Color(0xffC6A074),fontSize: 16,
              ),),
            ),
            Container(
              ...
              child: const Center(
                child: Padding(
                  ...
                  child: Text("FACIAL COSMETIC SURGERIES ALSO INCLUDE:",style: TextStyle(
            ...
            Row(
              ...
              children: const [
                Padding(
                  padding: EdgeInsets.all(8.0),
                  child: Text("Rhinoplasty:",style: TextStyle(
                    color: Color(0xffC6A074),fontSize: 16,
                  ),),
                ),
              ],
